...
class SOLUTION:
    ...
    def Generate_Body(self):
        ...
        pyrosim.Send_Cube(name="BackLeg", pos=[0,0,-0.5] , size=[0.3,0.3,1], mass=1)
        pyrosim.Send_Joint( name = "Torso_FrontLeg" , parent= "Torso" , child = "FrontLeg" , type = "revolute", position = [0,0.5,2.95], jointAxis = "0 1 0")
        pyrosim.Send_Cube(name="FrontLeg", pos=[0,0,-0.5] , size=[0.3,0.3,1], mass=1)
        pyrosim.Send_Joint( name = "Torso_RightArm" , parent= "Torso" , child = "RightArm" , type = "revolute", position = [0,0.5,4.2], jointAxis = "1 0 0")
        pyrosim.Send_Cube(name="RightArm", pos=[0,0.5,0] , size=[0.2,1,0.2], mass=0.2)
        pyrosim.Send_Joint( name = "RightArm_RightLowerArm" , parent= "RightArm" , child = "RightLowerArm" , type = "revolute", position = [0,0.9,-0.1], jointAxis = "0 1 0")
        pyrosim.Send_Cube(name="RightLowerArm", pos=[0,0,-0.5] , size=[0.2,0.2,1], mass=0.2)
        pyrosim.Send_Joint( name = "Torso_LeftArm" , parent= "Torso" , child = "LeftArm" , type = "revolute", position = [0,-0.5,4.2], jointAxis = "1 0 0")
        pyrosim.Send_Cube(name="LeftArm", pos=[0,-0.5,0] , size=[0.2,1,0.2], mass=0.2)
        pyrosim.Send_Joint( name = "LeftArm_LeftLowerArm" , parent= "LeftArm" , child = "LeftLowerArm" , type = "revolute", position = [0,-0.9,-0.1], jointAxis = "0 1 0")
        pyrosim.Send_Cube(name="LeftLowerArm", pos=[0,0,-0.5] , size=[0.2,0.2,1], mass=0.2)
        ...
        pyrosim.Send_Cube(name="FrontLowerLeg", pos=[0,0,-0.5] , size=[0.3,0.3,1], mass=1)
        ...
        pyrosim.Send_Cube(name="BackLowerLeg", pos=[0,0,-0.5] , size=[0.3,0.3,1], mass=1)
        ...
        pyrosim.Send_Cube(name="FrontFoot", pos=[0,0,-0.1] , size=[1,0.3,0.2], mass=6.5)
        ...
        pyrosim.Send_Cube(name="BackFoot", pos=[0,0,-0.1] , size=[1,0.3,0.2], mass=5.5)
        pyrosim.End()
    ...
    def Generate_Brain(self):
        ...
        pyrosim.Send_Motor_Neuron( name = 11 , jointName = "RightArm_RightLowerArm")
        pyrosim.Send_Motor_Neuron( name = 12 , jointName = "LeftArm_LeftLowerArm")
